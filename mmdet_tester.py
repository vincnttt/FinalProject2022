...
# _base_ = '/home/cent/PycharmProjects/final_project/mmdetection/' \
#          'configs/cascade_rcnn/cascade_mask_rcnn_r50_fpn_1x_coco.py'


# # TRAINING CODE START HERE
# dataset path initialization
BASE_DIR = '/home/cent/Desktop/fabric_defect'

TRAIN_JSON = BASE_DIR+'/annotations/train.json'
VAL_JSON = BASE_DIR+'/annotations/val.json'

TRAIN_ANN = BASE_DIR+'/cls_ann/train.txt'
VAL_ANN = BASE_DIR+'/cls_ann/val.txt'

TEMP_IMG = BASE_DIR+'/crop_temp/'
TRGT_IMG = BASE_DIR+'/crop_trgt/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=TRAIN_JSON, # Modified
        img_prefix=TRGT_IMG, # Modified
        classes=classes, # Added
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=VAL_JSON, # Modified
        img_prefix=TRGT_IMG, # Modified
        classes=classes, # Added
